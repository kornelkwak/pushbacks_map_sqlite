  ...
  <Stack spacing={4}>
    ...
    <Grid>
      <GridItem padding={1} col={8} xs={12}>
        <TextInput label="address" name="address" value={address}/>
      </GridItem>
      <GridItem padding={1} col={2} xs={12}>
        <TextInput label="longitude" name="longitude" value={longitude}/>
      </GridItem>
      <GridItem padding={1} col={2} xs={12}>
        <TextInput label="latitude" name="latitude" value={latitude}/>
      </GridItem>
    </Grid>
  </Stack>
  );
